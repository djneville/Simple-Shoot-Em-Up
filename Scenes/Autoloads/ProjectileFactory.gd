...
var projectile_scenes = {
    ProjectileType.TYPE.BULLET: preload("res://Scenes/Weapons/Projectiles/Bullet.tscn"),
    ProjectileType.TYPE.BOMB: preload("res://Scenes/Weapons/Projectiles/Bomb.tscn"),
    ProjectileType.TYPE.MISSILE: preload("res://Scenes/Weapons/Projectiles/Missile.tscn")
}
