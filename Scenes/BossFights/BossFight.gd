...
func _ready() -> void:
	...
	#self.active_path.add_child(boss_entity)
...
func _on_entry_path_completed() -> void:
	#active_path.remove_child(boss_entity)
	active_path = phase_one_path
	#active_path.add_child(boss_entity)
...
func _on_boss_death() -> void:
	...
	# Signal level completion or perform any additional cleanup
