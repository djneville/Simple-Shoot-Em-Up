...
func _ready():
    ...
    $MarginContainer/CenterContainer/VBoxContainer/StartGame.pressed.connect(_on_start_game_button_pressed)
    $MarginContainer/CenterContainer/VBoxContainer/LevelSelect.pressed.connect(_on_level_select_button_pressed)
