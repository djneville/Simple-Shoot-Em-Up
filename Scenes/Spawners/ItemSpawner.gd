...
@onready var bomb_item_scene: PackedScene = preload("res://Scenes/Items/BombItem.tscn")
@onready var upgrade_item_scene: PackedScene = preload("res://Scenes/Items/UpgradeItem.tscn")
