...
# Scenes
@onready
var bullet_scene: PackedScene = preload("res://Scenes/Weapon/Projectiles/BulletComponent.tscn")
@onready var bomb_scene: PackedScene = preload("res://Scenes/Weapon/Projectiles/BombComponent.tscn")
@onready
var missile_scene: PackedScene = preload("res://Scenes/Weapon/Projectiles/MissileComponent.tscn")
...
func release_projectile(
	shooter: Node, start_position: Vector2, type: Projectile.TYPE, direction: Vector2
) -> void:
	match type:
