...
@onready var enemy_base_scene: PackedScene = preload("res://godot/Entities/Enemies/EnemyEntity.tscn")
@onready var boss_base_scene: PackedScene = preload("res://godot/Entities/Bosses/BossEntity.tscn")
