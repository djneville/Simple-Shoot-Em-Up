...
@onready var health_item_scene: PackedScene = preload(ItemManager.HEALTH_ITEM)
@onready var bomb_item_scene: PackedScene = preload(ItemManager.BOMB_ITEM)
@onready var upgrade_item_scene: PackedScene = preload(ItemManager.UPGRADE_ITEM)
